...
public class Practice14GetFontMetricsView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        float offesetY = -(fontMetrics.ascent + fontMetrics.descent) / 2;
        canvas.drawText(texts[0], 100, middle + offesetY, paint2);
        canvas.drawText(texts[1], 200, middle + offesetY, paint2);
        canvas.drawText(texts[2], 300, middle + offesetY, paint2);
        canvas.drawText(texts[3], 400, middle + offesetY, paint2);
        canvas.drawText(texts[4], 500, middle + offesetY, paint2);
        canvas.drawText(texts[5], 600, middle + offesetY, paint2);
    }
}
