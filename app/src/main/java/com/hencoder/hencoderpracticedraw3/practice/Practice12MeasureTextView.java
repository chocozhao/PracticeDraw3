...
public class Practice12MeasureTextView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        float measureText = paint1.measureText(text1, 0, text1.length());
        float measureText1 = paint2.measureText(text2, 0, text2.length());
        canvas.drawText(text1, 5, 200, paint1);
        canvas.drawText(text2, 5 + measureText, 200, paint2);
        canvas.drawText(text3, measureText + measureText1, 200, paint1);
    }
}
